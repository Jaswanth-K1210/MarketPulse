"""S&P 100 ticker universe for GHAN-Lite."""
SP100_TICKERS = [
    "AAPL", "ABBV", "ABT", "ACN", "ADBE", "ADI", "ADM", "ADP", "ADSK", "AEE",
    "AEP", "AES", "AFL", "AIG", "AIZ", "AJG", "AKAM", "ALB", "ALK", "ALL",
    ...
    "BBY", "BDX", "BEN", "BF-B", "BMY", "BR", "BRK-B", "BRO", "BSX", "BWA",
    ...
    "FIS", "FISV", "FLT", "FMC", "FOX", "FOXA", "FRC", "FRT", "FTNT", "FTV",
    "GD", "GE", "GEN", "GILD", "GIS", "GL", "GLW", "GM", "GNRC", "GOOG",
    "GOOGL", "GPC", "GPN", "GRMN", "GS", "GWW", "HAL", "HAS", "HBAN", "HD",
